...
#include "TROOT.h"
#include "TMath.h"
//to execute over all output files run in output/out "./no_rotation_th_scan.sh"
void effDUT( ){
	...
	std::cout << std::endl;
	std::cout << "Eff. of S3: (" << counter1 << "/" << counter << ") = " <<  double(((counter1)/(counter))) << std::endl;

	std::cout << std::endl;
	std::cout << "Eff. of S2: (" << counter3 << "/" << counter2 << ") = " << double(((counter3)/(counter2))) << std::endl;

	std::cout << std::endl;
	std::cout << "Eff. of S1: (" << counter5 << "/" << counter4 << ") = " << double(((counter5)/(counter4))) << std::endl;
